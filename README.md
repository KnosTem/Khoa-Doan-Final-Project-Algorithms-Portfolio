...
## Author
Khoa Doan - COSC 2436, Spring 2026

## Description
This portfolio covers foundational data structures and algorithms in Python, progressing from basic search and sort techniques through graphs, binary tree, dynamic programming,.... My goal was to have an understanding of each algorithm and the ability to analyze its time complexity and real-world tradeoffs.
