...
- **When to use it:** Use binary search whenever the data is sorted and you need fast lookups at scale. Use linear search for small or unsorted arrays where simplicity matters more than speed.
